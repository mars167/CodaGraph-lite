...
function OAuthCallbackContent({ forcedPlatform }: { forcedPlatform?: Platform }) {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      const platform = forcedPlatform || resolveOAuthPlatform(searchParams.get('platform'), state);
    ...
    void handleCallback();
  }, [error, forcedPlatform, router, searchParams, success]);
...
export function OAuthCallbackPageClient({ forcedPlatform }: { forcedPlatform?: Platform } = {}) {
  return (
    <Suspense fallback={<LoadingFallback />}>
      <OAuthCallbackContent forcedPlatform={forcedPlatform} />
    </Suspense>
  );
}
